...
export class Book {
    private constructor(private readonly id: BookId, private readonly title: BookTitle, private readonly author: BookAuthor) {
    }
...
export class BookId {
    ...
    static of(value?: string): BookId {
        assert('bookId').of(value)
            .isNotEmpty()
            .isNotLongerThan(BookId.size)
            .matches(BookId.alphabetRegExp);
...
export class BookAuthor {
    ...
    static of(value?: string): BookAuthor {
        assert('bookAuthor').of(value)
            .isNotEmpty()
            .isNotLongerThan(BookAuthor.maxLength);
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
...
export class BookTitle {
    ...
    static of(value?: string): BookTitle {
        assert('bookTitle').of(value)
            .isNotEmpty()
            .isNotLongerThan(BookTitle.maxLength);
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
